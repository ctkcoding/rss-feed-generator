...
class WatcherServiceTest {
    ...
    void watchLoop_realFileEvent_setsNewFileChangesFlag() throws Exception {
        ...
        try {
            ...
            assertTrue(watcherService.newFileChanges.get(), "Flag should be set after new episode file created");
    ...
    void watchLoop_nonEpisodeFile_doesNotSetFlag() throws Exception {
        ...
        try {
            ...
            assertFalse(watcherService.newFileChanges.get(), "Flag should not be set for non-episode file");
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            fail("Test interrupted");
         } finally {
